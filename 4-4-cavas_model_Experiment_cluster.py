...
# CONFIGS
# =============================================================================
LOCAL_RUN              = False   # False  → modalità HPC
RUNNING_ON_HPC         = True    # True   → percorsi e Spark settati per il cluster
RANDOM_SEED            = 61
...
# Percorso base su cluster (tutti gli output finiscono qui)
        ...
        for metodo in PUCKTRICK_METHODS:
            for pct in PERCENTAGES:
                ...
                try:
                    ...
                    print(f"Error: {metodo} on {colonna_da_sporcare} at {pct*100:.1f}%: {e}")
                finally:
                    clear_memory()

    # ── Esperimenti duplicated ────────────────────────────────────────
    PUCKTRICK_METHODS = ['duplicated']
    colonna_da_sporcare = 'Timestamp'   # duplicated agisce sull'intera riga
